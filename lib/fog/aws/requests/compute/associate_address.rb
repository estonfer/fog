    ...
    class AWS
      ...
      class Mock
        ...
        def associate_address(instance_id=nil, public_ip=nil, network_interface_id=nil, allocation_id=nil)
          ...
          response.status = 200
          instance = instance_id.nil? ? nil : self.data[:instances][instance_id]
          ...
          if ((instance && address) || (instance &&  !allocation_id.nil?) || (!allocation_id.nil? && !network_interface_id.nil?))
            ...
            raise Fog::Compute::AWS::Error.new("You must specify an AllocationId when specifying a NetworkInterfaceID")
          elsif ! instance && network_interface_id.nil?
